...
namespace Crosstales
{
   ...
   public static class ExtensionMethods
   {
     ...
     private static string toTitleCase(string str)
     {
      ...
      public static string Replace(this string str, string oldString, string newString, System.StringComparison comp = System.StringComparison.OrdinalIgnoreCase)
      {
         if (str == null)
            throw new System.ArgumentNullException(nameof(str));
      ...
      public static bool Equals(this string str, string toCheck, System.StringComparison comp = System.StringComparison.OrdinalIgnoreCase)
      {
         if (str == null)
            throw new System.ArgumentNullException(nameof(str));
      ...
      /// <param name="comp">StringComparison-method (default: StringComparison.OrdinalIgnoreCase, optional)</param>
      /// <returns>True if the string contains the given string.</returns>
      public static bool Contains(this string str, string toCheck, System.StringComparison comp = System.StringComparison.OrdinalIgnoreCase)
      {
         if (str == null)
            throw new System.ArgumentNullException(nameof(str));
      ...
      public static bool ContainsAny(this string str, string searchTerms, char splitChar = ' ')
      {
         if (str == null)
            throw new System.ArgumentNullException(nameof(str));
         ...
         return searchTerms.Split(split, System.StringSplitOptions.RemoveEmptyEntries).Any(searchTerm => str.Contains(searchTerm));
      }
      ...
      public static bool ContainsAll(this string str, string searchTerms, char splitChar = ' ')
      {
         if (str == null)
            throw new System.ArgumentNullException(nameof(str));
         ...
         return searchTerms.Split(split, System.StringSplitOptions.RemoveEmptyEntries).All(searchTerm => str.Contains(searchTerm));
      }
      ...
      public static string Dump<T>(this T[] array, string prefix = "", string postfix = "")
      {
         if (array == null) // || array.Length <= 0)
            throw new System.ArgumentNullException(nameof(array));
      ...
      /// <returns>String with lines for all array entries.</returns>
      public static string Dump(this Quaternion[] array)
      {
         if (array == null) // || array.Length <= 0)
            throw new System.ArgumentNullException(nameof(array));
      ...
      /// <returns>String with lines for all array entries.</returns>
      public static string Dump(this Vector2[] array)
      {
         if (array == null) // || array.Length <= 0)
            throw new System.ArgumentNullException(nameof(array));
      ...
      /// <returns>String with lines for all array entries.</returns>
      public static string Dump(this Vector3[] array)
      {
         if (array == null) // || array.Length <= 0)
            throw new System.ArgumentNullException(nameof(array));
      ...
      /// <returns>String with lines for all array entries.</returns>
      public static string Dump(this Vector4[] array)
      {
         if (array == null) // || array.Length <= 0)
            throw new System.ArgumentNullException(nameof(array));
      ...
      /// <param name="seed">Seed for the PRNG (default: 0 (=standard), optional)</param>
      public static void Shuffle<T>(this System.Collections.Generic.IList<T> list, int seed = 0)
      {
         if (list == null)
      ...
      public static string Dump<T>(this System.Collections.Generic.IList<T> list, string prefix = "", string postfix = "")
      {
         if (list == null)
            throw new System.ArgumentNullException(nameof(list));
      ...
      /// <returns>String with lines for all list entries.</returns>
      public static string Dump(this System.Collections.Generic.IList<Quaternion> list)
      {
         if (list == null)
            throw new System.ArgumentNullException(nameof(list));
      ...
      /// <returns>String with lines for all list entries.</returns>
      public static string Dump(this System.Collections.Generic.IList<Vector2> list)
      {
         if (list == null)
            throw new System.ArgumentNullException(nameof(list));
      ...
      /// <returns>String with lines for all list entries.</returns>
      public static string Dump(this System.Collections.Generic.IList<Vector3> list)
      {
         if (list == null)
            throw new System.ArgumentNullException(nameof(list));
      ...
      /// <returns>String with lines for all list entries.</returns>
      public static string Dump(this System.Collections.Generic.IList<Vector4> list)
      {
         if (list == null)
            throw new System.ArgumentNullException(nameof(list));
      ...
      public static System.Collections.Generic.List<string> ToString<T>(this System.Collections.Generic.IList<T> list)
      {
         if (list == null)
            throw new System.ArgumentNullException(nameof(list));
      ...
      public static string Dump<K, V>(this System.Collections.Generic.IDictionary<K, V> dict, string prefix = "", string postfix = "")
      {
         if (dict == null)
      ...
      public static void AddRange<K, V>(this System.Collections.Generic.IDictionary<K, V> dict, System.Collections.Generic.IDictionary<K, V> collection)
      {
         if (dict == null)
            throw new System.ArgumentNullException(nameof(dict));
      ...
      /// <returns>True if the renderer Is visible by the given camera.</returns>
      public static Transform DeepSearch(Transform parent, string name)
      {
         if (parent == null)
      ...
      public static byte[] ReadFully(this System.IO.Stream input, int bufferSize = 16384)
      {
         if (input == null)
      ...
      */
      /*
          ...
          public static List<T> Clone<T>(this List<T> listToClone) where T : ICopyable
          {
