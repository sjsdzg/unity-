    ...
    public class CameraController : MonoBehaviour
    {
        ...
        public Transform Target
        {
            ...
            set
            {
                ...
                TextMeshPro = target.GetComponentInChildren<TextMeshPro>();
            }
        }
        ...
        [SerializeField]
        private PersonMode m_PersonMode = PersonMode.ThirdPerson;
        /// <summary>
        /// 人称模式
        /// </summary>
        public PersonMode PersonMode
        {
            get { return m_PersonMode; }
            set
            {
                m_PersonMode = value;
                if (smrs != null)
        ...
        void Start()
        {
            ...
            if (target == null)
            {
                Debug.Log("Please set a transform to 'Target'!");
                //return;
            }
            else
            {
