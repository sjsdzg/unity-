...
{
    public class ProteinPurificationStageScene : ProductionSimulationScene
    {
        ...
        protected override void ParseSceneParam()
        {
            ...
            //解析
            SceneParam param = SceneLoader.Instance.GetSceneParam(SceneType.ProteinPurificationStageScene);
            ...
            //StageType = StageType.ProteinPurificationStage;
