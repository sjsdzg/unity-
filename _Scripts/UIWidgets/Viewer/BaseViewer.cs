...
namespace XFramework.UIWidgets
{
    ...
    public class BaseViewer : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        [SerializeField]
        private ScaleEvent m_OnScaleChanged = new ScaleEvent();
        /// <summary>
        /// 缩放值更改时触发
        /// </summary>
        public ScaleEvent onScaleChanged
        {
            get { return m_OnScaleChanged ; }
            set { m_OnScaleChanged  = value; }
        }
        ...
        /// 缩放增量
        /// </summary>
        private float m_ScaleSensitivity = 0.1f;

        /// <summary>
        /// 缩放最小值
        /// </summary>
        [SerializeField]
        private float m_ScaleMin = 0.25f;
