...
{
    public class SectionContentComponent : MonoBehaviour
    {
        ...
        /// 工具项组件列表
        /// </summary>
        public List<SectionItemComponent> m_Components { get; private set; }
        ...
        private void Awake()
        {
            m_Components = new List<SectionItemComponent>();
        ...
        public void AddItem(Stage data)
        {
            GameObject obj = Instantiate(DefaultItem);
            obj.SetActive(true);

            SectionItemComponent component = obj.GetComponent<SectionItemComponent>();
        ...
        public void RemoveItem(string name)
        {
            ...
            {
                SectionItemComponent component = m_Components[i];
        ...
        public void Clear()
        {
            for (int i = 0; i < m_Components.Count; i++)
            {
                SectionItemComponent item = m_Components[i];
