...
{
    public class ManageNetworkImagePanel : AbstractPanel
    {
        ...
        protected override void SetPanel(params object[] PanelParams)
        {
            ...
            addressBar.AddHyperButton(EnumPanelType.ManageEmpiricalPanel, PanelDefine.GetPanelComment(EnumPanelType.ManageNetworkImagePanel));
            queryBar.SetFileTypes(NetworkFile.GetImageTypes());
            //分页查询
