...
{
    public class ManageNetworkVideoPanel : AbstractPanel
    {
        ...
        {
            return EnumPanelType.ManageNetworkImagePanel;
        }
        ...
        protected override void SetPanel(params object[] PanelParams)
        {
            ...
            addressBar.AddHyperButton(EnumPanelType.ManageEmpiricalPanel, PanelDefine.GetPanelComment(EnumPanelType.ManageNetworkVideoPanel));
            queryBar.SetFileTypes(NetworkFile.GetVideoTypes());
            //分页查询
