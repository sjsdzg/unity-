...
namespace XFramework.UI
{
    ...
    /// 操作日志管理Panel
    /// </summary>
    public class ManageLoginLogPanel: AbstractPanel
    {
        ...
        {
            return EnumPanelType.ManageLoginLogPanel;
        }
        ...
        /// 用户操作日志用户查询栏目
        /// </summary>
        private LoginLogQueryBar queryBar;
        ...
        private void InitGUI()
        {
            ...
            queryBar = transform.Find("QueryBar").GetComponent<LoginLogQueryBar>();
        }
        ...
        private void pageDataGrid_ButtonCellClick(DataGridViewRow row, ButtonCellType type)
        {
            ...
            switch (type)
            {
                case ButtonCellType.Detail:
                    PanelManager.Instance.OpenPanelCloseOthers(this.Parent, EnumPanelType.UserLoginLogPanel, user);
                    break;
                default:
                    break;
            }
