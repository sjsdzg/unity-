...
namespace XFramework.UI
{
    public class UserLoginLogQueryBar : QueryBar
    {
        ...
        protected override List<SqlCondition> BuildSqlConditions()
        {
            ...
            //关键字
            sqlConditions.Add(new SqlCondition(USER_NAME, SqlOption.Equal, user.UserName));
            //排序 按时间降序
        ...
        public void SetUser(User user)
        {
            ...
            inputFieldRealName.text = user.RealName;
        }
    }
}
