...
namespace XFramework.UI
{
    ...
    /// 操作日志管理Panel
    /// </summary>
    public class ManageOperationLogPanel : AbstractPanel
    {
        ...
        {
            return EnumPanelType.ManageOperationLogPanel;
        }
        ...
        /// 用户操作日志用户查询栏目
        /// </summary>
        private OperationLogQueryBar queryBar;
        ...
        private void InitGUI()
        {
            ...
            queryBar = transform.Find("QueryBar").GetComponent<OperationLogQueryBar>();
        }
        ...
        private void pageDataGrid_ButtonCellClick(DataGridViewRow row, ButtonCellType type)
        {
            ...
            switch (type)
            {
                case ButtonCellType.Detail:
                    PanelManager.Instance.OpenPanelCloseOthers(this.Parent, EnumPanelType.UserOperationLogPanel, user);
                    break;
                default:
                    break;
            }
