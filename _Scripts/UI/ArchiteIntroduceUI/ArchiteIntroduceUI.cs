...
public class ArchiteIntroduceUI : BaseUI
{
    ...
    /// 范例讲解模块
    /// </summary>
    private ArchiteIntroduceModule module;
    /// <summary>
    /// 流程
    /// </summary>
    ...
    {
        return EnumUIType.ArchiteIntroduceUI;
    }
    protected override void OnAwake()
    {
        base.OnAwake();
        ModuleManager.Instance.Register<ArchiteIntroduceModule>();
        module = ModuleManager.Instance.GetModule<ArchiteIntroduceModule>();
        ...
        ArchiteIntroduceAudioController.Instance.RootPath = "Assets/Audios/ArchiteIntroduce/";
