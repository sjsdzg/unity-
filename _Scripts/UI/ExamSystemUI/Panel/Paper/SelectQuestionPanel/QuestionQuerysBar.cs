...
{
    public class QuestionQuerysBar : QueryBar
    {
        public const string CONTENT = "content";//关键词
        public const string BANK_ID = "bank_id";//题库Id
        public const string TYPE = "type";//试题类型
        public const string LEVEL = "level";//试题难度
