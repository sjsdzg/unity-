...
{
    public class UserQueryBar : QueryBar
    {
        ...
        public override void OnAwake()
        {
            ...
            dropdownGrade = transform.Find("Conditions/DropdownGrade").GetComponent<Dropdown>();
            dropdownPosition = transform.Find("Conditions/DropdownPosition").GetComponent<Dropdown>();
            //dropdownRole = transform.Find("Conditions/DropdownRole").GetComponent<Dropdown>();
        ...
        protected override List<SqlCondition> BuildSqlConditions()
        {
            ...
            {
                string text = dropdownGrade.options[dropdownGrade.value].text.Trim();
                Debug.Log(text);
                sqlConditions.Add(new SqlCondition(Constants.Grade, SqlOption.Equal, SqlType.String, text));
            }
            //班级Id
