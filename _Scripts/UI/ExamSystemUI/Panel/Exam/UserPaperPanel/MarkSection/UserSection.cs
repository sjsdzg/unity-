...
{
    public class UserSection : MonoBehaviour
    {
        ...
        public ExamSectionJson ExamSectionJson
        {
            get
            {
                ...
                foreach (UserQuestion item in UserQuestions)
                {
            ...
            set
            {
                ...
                {
                    UserQuestion markQuestion = UserQuestions[i];
        ...
        /// 试题组件列表
        /// </summary>
        private List<UserQuestion> UserQuestions = null;
        ...
        public void AddQuestion(Question question)
        {
            ...
            UserQuestion component = obj.GetComponent<UserQuestion>();

            if (Content != null && component != null)
            {
                component.transform.SetParent(Content, false);
                obj.layer = Content.gameObject.layer;
                UserQuestions.Add(component);
                component.OnCompleted.AddListener(component_OnCompleted);
                component.Question = question;
                component.SetMaxScore(paperSection.Score);
                component.Number = StartNum + UserQuestions.Count;
            }
        }

        public UserQuestion GetUserQuestion(int number)
        {
            UserQuestion examQuestion = UserQuestions[number - StartNum - 1];
            return examQuestion;
        }
        ...
        public void Clear()
        {
            ...
            {
                UserQuestion component = UserQuestions[i];
