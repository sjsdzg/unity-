...
{
    public class UserPaperPanel : AbstractPanel
    {
        public override EnumPanelType GetPanelType()
        {
            return EnumPanelType.UserPaperPanel;
        }

        /// <summary>
        /// 
        /// </summary>
        private UserSectionBar markSectionBar;

        /// <summary>
        /// 序号索引视图
        /// </summary>
        private UserViewBar markViewBar;

        /// <summary>
        /// 考试标题
        /// </summary>
        private UserTitleBar markTitleBar;
        ...
        {
            markSectionBar = transform.Find("Background/UserSectionBar").GetComponent<UserSectionBar>();
            markViewBar = transform.Find("Background/UserViewBar").GetComponent<UserViewBar>();
            markTitleBar = transform.Find("Background/UserSectionBar/Viewport/Content/TitleBar").GetComponent<UserTitleBar>();
        ...
        {
            PanelManager.Instance.ClosePanel(EnumPanelType.UserPaperPanel);
        }
        ...
        protected override void SetPanel(params object[] PanelParams)
        {
            ...
            {
                UserPaperPanelData data = PanelParams[0] as UserPaperPanelData;
    ...
    /// 考试面板数据类
    /// </summary>
    public class UserPaperPanelData
    {
        /// <summary>
        /// 考试数据
        /// </summary>
