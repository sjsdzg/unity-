...
{
    public class MarkViewBar : MonoBehaviour
    {
        ...
        /// 选项列表
        /// </summary>
        private List<MarkView> MarkViewComponents;
        ...
        void Awake()
        {
            MarkViewComponents = new List<MarkView>();
            if (DefaultItem == null)
            {
        ...
        public void AddPaperSection()
        {
            ...
            MarkView component = obj.GetComponent<MarkView>();
            ...
            if (Content != null && component != null)
            {
                ...
                MarkViewComponents.Add(component);
        ...
        IEnumerator BuildPaperSection(List<PaperSection> sections)
        {
            ...
            int start = 0;
            for (int i = 0; i < MarkViewComponents.Count; i++)
            {
                PaperSection section = sections[i];
                MarkView component = MarkViewComponents[i];
                component.Id = i + 1;
        ...
        {
            if (sectionId <= MarkViewComponents.Count)
            {
                MarkView examView = MarkViewComponents[sectionId - 1];
