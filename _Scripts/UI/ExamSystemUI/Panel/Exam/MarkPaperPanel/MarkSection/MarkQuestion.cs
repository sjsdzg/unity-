...
{
    public class MarkQuestion : MonoBehaviour
    {
            ...
            set
            {
                ...
                switch (question.Type)
                {
                    case ExamSystemConstants.QuestionType.SINGLE_CHOICE:
                        ...
                        for (int i = 0; i < questionSingleChoice.Options.Count; i++)
                        {
                            MarkOptionComponent component = OptionComponents[i];
        ...
        /// MarkScoreComponent
        /// </summary>
        private MarkScoreComponent markScoreComponent;
        ...
        /// OptionComponents
        /// </summary>
        private List<MarkOptionComponent> OptionComponents = new List<MarkOptionComponent>();
        ...
        void Awake()
        {
            ...
            markScoreComponent = transform.Find("Score").GetComponent<MarkScoreComponent>();
        ...
        public void AddOption(string name, bool isOn, string content)
        {
            ...
            MarkOptionComponent component = obj.GetComponent<MarkOptionComponent>();
