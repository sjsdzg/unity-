...
{
    public class MarkSectionBar : MonoBehaviour
    {
        ...
        public List<ExamSectionJson> ExamSectionJsons
        {
            get
            {
                ...
                foreach (var item in MarkSectionComponents)
                {
            ...
            set
            {
                ...
                for (int i = 0; i < MarkSectionComponents.Count; i++)
                {
                    MarkSection markSection = MarkSectionComponents[i];
        ...
        /// 选项列表
        /// </summary>
        private List<MarkSection> MarkSectionComponents;

        void Awake()
        {
            MarkSectionComponents = new List<MarkSection>();
            if (DefaultItem == null)
            {
        ...
        public void AddPaperSection()
        {
            ...
            MarkSection component = obj.GetComponent<MarkSection>();
            ...
            if (Content != null && component != null)
            {
                ...
                MarkSectionComponents.Add(component);
        ...
        IEnumerator BuildPaperSection(List<PaperSection> sections)
        {
            ...
            for (int i = 0; i < MarkSectionComponents.Count; i++)
            {
                ...
                MarkSection component = MarkSectionComponents[i];
                component.Id = i + 1;
        ...
        {
            CenterOnItem(MarkSectionComponents[sectionId - 1].GetMarkQuestion(number).GetComponent<RectTransform>());
        }
