...
{
    public class MarkSection : MonoBehaviour
    {
        ...
        public ExamSectionJson ExamSectionJson
        {
            get
            {
                ...
                foreach (MarkQuestion item in MarkQuestions)
                {
            ...
            set
            {
                ...
                {
                    MarkQuestion markQuestion = MarkQuestions[i];
                    markQuestion.ExamQuesJson = examSectionJson.QuesJsons[i];
                }
            }
        }
        ...
        /// 试题组件列表
        /// </summary>
        private List<MarkQuestion> MarkQuestions = null;
        ...
        {
            MarkQuestions = new List<MarkQuestion>();
            if (DefaultItem == null)
            {
        ...
        public void AddQuestion(Question question)
        {
            ...
            MarkQuestion component = obj.GetComponent<MarkQuestion>();

            if (Content != null && component != null)
            {
                component.transform.SetParent(Content, false);
                obj.layer = Content.gameObject.layer;
                MarkQuestions.Add(component);
                component.OnCompleted.AddListener(component_OnCompleted);
                component.Question = question;
                component.SetMaxScore(paperSection.Score);
                component.Number = StartNum + MarkQuestions.Count;
            }
        }

        public MarkQuestion GetMarkQuestion(int number)
        {
            MarkQuestion examQuestion = MarkQuestions[number - StartNum - 1];
            return examQuestion;
        }
        ...
        public void Clear()
        {
            ...
            {
                MarkQuestion component = MarkQuestions[i];
