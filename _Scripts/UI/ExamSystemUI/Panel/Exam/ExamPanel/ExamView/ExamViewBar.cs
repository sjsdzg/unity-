...
{
    public class ExamViewBar : MonoBehaviour
    {
        ...
        /// 选项列表
        /// </summary>
        private List<ExamView> ExamViewComponents;
        ...
        void Awake()
        {
            ExamViewComponents = new List<ExamView>();
            if (DefaultItem == null)
            {
        ...
        public void AddPaperSection()
        {
            ...
            ExamView component = obj.GetComponent<ExamView>();
            ...
            if (Content != null && component != null)
            {
                ...
                ExamViewComponents.Add(component);
        ...
        IEnumerator BuildPaperSection(List<PaperSection> sections)
        {
            ...
            int start = 0;
            for (int i = 0; i < ExamViewComponents.Count; i++)
            {
                PaperSection section = sections[i];
                ExamView component = ExamViewComponents[i];
                component.Id = i + 1;
        ...
        {
            if (sectionId <= ExamViewComponents.Count)
            {
                ExamView examView = ExamViewComponents[sectionId - 1];
