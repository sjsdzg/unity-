...
{
    public class ManualGradingPanel : AbstractPanel
    {
        ...
        {
            return EnumPanelType.ManualGradingPanel;
        }
        ...
        /// 考试查询栏目
        /// </summary>
        private ManualGradingQueryBar queryBar;
        ...
        private void InitGUI()
        {
            ...
            queryBar = transform.Find("QueryBar").GetComponent<ManualGradingQueryBar>();
        }
        ...
        private void pageDataGrid_ButtonCellClick(DataGridViewRow row, ButtonCellType type)
        {
            ...
            switch (type)
            {
                //case ButtonCellType.StartExamData:
                //    Transform popupPanelContainer = PanelManager.Instance.PanelContainers[PanelContainerType.PopupPanelContainer];
                //    StartExamDataPanelData data = new StartExamDataPanelData();
                //    data.ExamDataInfo = examData;
                //    PanelManager.Instance.OpenPanel(popupPanelContainer, EnumPanelType.StartExamDataPanel, data);
                //    break;
                case ButtonCellType.MakePaper://阅卷
                    Transform popupPanelContainer = PanelManager.Instance.PanelContainers[PanelContainerType.PopupPanelContainer];
                    MarkPaperPanelData data = new MarkPaperPanelData();
                    data.ExamDataInfo = examData;
                    ...
                    {
                        PanelManager.Instance.OpenPanel(popupPanelContainer, EnumPanelType.MarkPaperPanel, data);
                    }
                    break;
                default:
                    break;
