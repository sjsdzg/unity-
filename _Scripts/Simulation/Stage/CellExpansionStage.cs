...
namespace XFramework.Simulation
{
    ...
    /// 细胞扩增工段
    /// </summary>
    public class CellExpansionStage : CustomStage
    {
        ...
        {
            base.InitStandard();
            LoadWorkshops(new EnumWorkshopType[] { EnumWorkshopType.CellExpansionWorkshop });
            EventDispatcher.ExecuteEvent(Events.Item.Goods.Add, GoodsType.Cell_SYQC_01.ToString());
        }
                ...
                case DocumentType.AssessmentReport:
                    MessageBoxEx.Show("是否结束本次考核？", "提示", MessageBoxExEnum.CommonDialog, x =>
                    {
                        ...
                        if (b)
                        {
                            ...
                            setting.Data = new object[3] { "细胞扩增考核记录", AssessmentGrade, CheckQuestionList };
