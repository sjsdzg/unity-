...
{
    public static class PLC_100LReservoirTankEvent
    {
        public static readonly string ActiveToggleMotor = "PLC_100LReservoirTankEvent.ActiveToggleMotor";
        public static readonly string StartMotor = "PLC_100LReservoirTankEvent.StartMotor";
        public static readonly string StopMotor = "PLC_100LReservoirTankEvent.StopMotor";
    }
    public class PLC_100LReservoirTank : MonoBehaviour
    {
        ...
        PLC_100LDispensingTank plc_100LDispensingTank;
        ...
        {
            plc_100LDispensingTank = transform.parent.Find("配制罐").GetComponent<PLC_100LDispensingTank>();
        ...
        private void InitEvent()
        {
            ...
            EventDispatcher.RegisterEvent(PLC_100LReservoirTankEvent.ActiveToggleMotor, ActiveToggleMotor);
        }
        ...
        private void ToggleMotorChanged(bool isOn)
        {
            ...
            if (isOn)
            {
                ...
                EventDispatcher.ExecuteEvent(PLC_100LReservoirTankEvent.StartMotor);
            }
            else
            {
                imageMotor.color = new Color(255, 255, 255, 0);
                EventDispatcher.ExecuteEvent(PLC_100LReservoirTankEvent.StopMotor);
            }
        }
        ...
        {
            EventDispatcher.UnregisterEvent(PLC_100LReservoirTankEvent.ActiveToggleMotor, ActiveToggleMotor);
        }
    }
