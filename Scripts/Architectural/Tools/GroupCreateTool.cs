...
{
    public class GroupCreateToolArgs : ToolArgs
    {
        public Group Group { get; set; }
    }

    public class GroupCreateTool : ToolBase
    {
        ...
        public override void Init(ToolArgs t)
        {
            ...
            TopMost = true;
            hasSumbit = false;
            GroupCreateToolArgs args = (GroupCreateToolArgs)t;
            group = args.Group;
            ...
            ArchitectUtility.RegisterGroupForCreate(group);
        }
        ...
        public override void Submit()
        {
            ...
            EventDispatcher.ExecuteEvent<Group>(Architect.AddGroupEvent, group);
