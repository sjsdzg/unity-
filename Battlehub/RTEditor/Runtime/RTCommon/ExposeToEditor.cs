...
namespace Battlehub.RTCommon
{
    ...
    public class ExposeToEditor : MonoBehaviour, INotifyPropertyChanged
    {
        ...
        //In some cases, the user should be able to disable the Parent Changed event to avoid costly (RTE) UI operations.
        ...
        [SerializeField, FormerlySerializedAs("BoundsObject")]
        private GameObject m_boundsObject;
        public GameObject BoundsObject
        {
            get { return m_boundsObject == null ? gameObject : m_boundsObject; }
            set { m_boundsObject = value; }
        }
        ...
        private void SetHideFlags(ExposeToEditor obj, bool value)
        {
            ...
            {
                if (obj.gameObject.hideFlags != HideFlags.HideAndDontSave)
                {
                    obj.gameObject.hideFlags &= ~HideFlags.DontSave;
                    obj.hideFlags &= ~HideFlags.DontSave;
                } 
        ...
        public bool ActiveSelf
        {
            ...
            set
            {
                if(ActiveSelf != value)
                {
                    ...
                    RaisePropertyChanged(nameof(gameObject));
                }
            }
        }
        ...
        public ExposeToEditor GetParent(bool includeMarkedAsDestroyed = false)
        {
            if (transform.parent != null)
            {
                ...
                if (parent != null && !parent.m_isDestroyed && (includeMarkedAsDestroyed || !parent.MarkAsDestroyed))
                {
                    return parent;
                }
            }
        ...
        public List<ExposeToEditor> GetChildren(bool includeMarkedAsDestroyed = false)
        {
            ...
            foreach (Transform childTransform in transform)
            {
                ...
                if (child != null && !child.m_isDestroyed && (includeMarkedAsDestroyed || !child.MarkAsDestroyed))
                {
                    children.Add(child);
                }
            }
