...
namespace Battlehub.RTCommon
{
    ...
    public static class RenderPipelineInfo
    {
        ...
        static RenderPipelineInfo()
        {
            ...
            {
                Type pipelineType = GraphicsSettingsExt.renderPipelineAsset.GetType();
        ...
        {
#if !UNITY_6000_0_OR_NEWER
            if (Type == RPType.Standard && IsXRDevicePresent())
            {
    ...
    public static class MaterialExt
    {
        ...
        public static void NormalTexture(this Material material, Texture texture, float smoothness = -1)
        {
            if (material.HasProperty(NormalTextureProperyID))
            {
                ...
                if (smoothness != -1 && material.HasProperty("_Smoothness"))
                {
    ...
    public class MaterialAcessor
    {
        ...
        {
            get { return material.NormalTexture(); }
        ...
        {
            get { return material.NormalTexture(); }
            set { material.NormalTexture(value, 0); }
        }
