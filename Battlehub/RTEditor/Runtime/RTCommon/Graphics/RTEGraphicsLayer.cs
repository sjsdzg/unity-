...
namespace Battlehub.RTCommon
{
    ...
    public class RTEGraphicsLayer : MonoBehaviour, IRTEGraphicsLayer
    {
        ...
        private void PrepareGraphicsLayerCamera()
        {
            ...
            {
                m_graphicsCamera = m_graphics.CreateCamera(m_camera, CameraEvent.BeforeImageEffects, false, false);
            }
            else
            {
                m_graphicsCamera = m_graphics.CreateCamera(m_camera, CameraEvent.AfterImageEffectsOpaque, false, false);
            }
        ...
        private void OnEndContextRendering(ScriptableRenderContext arg1, System.Collections.Generic.List<Camera> arg2)
        {
            RenderPipelineManager.endContextRendering -= OnEndContextRendering;
