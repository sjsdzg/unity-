        ...
        public override Vector3 CameraPosition
        {
            ...
            set
            {
                ...
                if(camera.orthographic)
                {
                    ...
                    camera.orthographicSize = m_orbitDistance * Mathf.Sin(fov / 2.0f);
            ...
            if (Grid != null)
            {
                if (IsOrthographic)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Grid.Alpha += Time.unscaledDeltaTime * 5;
                        }
                    }
                }
                else
                {
                    ...
                    {
                        Grid.Alpha -= Time.unscaledDeltaTime * 25;
                    }
                    else
                    {
                        Grid.Alpha += Time.unscaledDeltaTime * 5;
            ...
            else
            {
                if (!MathHelper.Approximately(camTransform.rotation, m_targetRotation))
                {
                    camTransform.rotation = Quaternion.Slerp(
                        ...
                        m_targetRotation,
                        m_freeRotationSmoothSpeed * Time.unscaledDeltaTime);
                }
            }
            ...
            else
            {
                if (!MathHelper.Approximately(m_targetPosition, camTransform.position))
                {
                    Vector3 newPosition = Vector3.Lerp(
                        ...
                        m_targetPosition,
                        m_freeMovementSmoothSpeed * Time.unscaledDeltaTime);
