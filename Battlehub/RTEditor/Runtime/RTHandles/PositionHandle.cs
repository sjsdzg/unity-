...
namespace Battlehub.RTHandles
{
    ...
    public class PositionHandle : BaseHandle
    {
        ...
        private void BeginSnap()
        {
            ...
            ExposeToEditor[] exposeToEditorObjects = UnityObjectExt.FindObjectsByType<ExposeToEditor>();
        ...
        protected override void RefreshCommandBuffer(IRTECamera camera)
        {
            ...
            Appearance.DoPositionHandle(camera.RTECommandBuffer, camera.Camera, m_settings, IsInVertexSnappingMode || Editor.Tools.IsSnapping);
        }
