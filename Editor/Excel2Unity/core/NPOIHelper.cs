    ...
    public static class NPOIHelper
    {
        ...
        public static bool IsMergeCell(this ISheet sheet, int rowIndex, int columnIndex, out Dimension dimension)
        {
            ...
            if (rowIndex >= 0 && sheet.LastRowNum >= rowIndex)
            {
                ...
                {
                    dimension.DataCell = sheet.GetRow(rowIndex).GetCell(columnIndex);
                    result = false;
                }
            }
            else
        ...
        /// <returns></returns>
        public static IWorkbook InitializeWorkbook(string excelFile)
        {
        ...
        public static string GetStringValue(this ICell cell)
        {
            ...
            switch (cell.CellType)
            {
                ...
                case CellType.Formula:
                    IFormulaEvaluator fe = WorkbookFactory.CreateFormulaEvaluator(cell.Sheet.Workbook);
                    ...
                    switch (cellValue.CellType)
                    {
                        case CellType.Blank:
                            break;
                        case CellType.Boolean:
                            value = cellValue.BooleanValue.ToString();
                            break;
                        case CellType.Error:
                            break;
                        case CellType.Formula:
                        ...
                        case CellType.String:
                            value = cellValue.StringValue.ToString();
                            break;
